...
def train(args, train_dataset, label_dataset, model, tokenizer):
    """ Train the model """
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            ...
            if args.doc_batching:
                ...
                labels = batch[3][0]
                ranks = batch[-1][0]
            inputs = {"doc_input_ids": batch[0][0], "doc_attention_mask": batch[1][0], "labels": labels, "ranks": ranks}
...
def main():
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, label_dataset, model, tokenizer)
