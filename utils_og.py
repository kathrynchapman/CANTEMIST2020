...
class MyProcessor(DataProcessor):
    ...
    def __init__(self, args, test_file=None):
        self.train_file = os.path.join(args.data_dir, 'train_{}_{}.p'.format(args.label_threshold, args.ignore_labelless_docs))
        self.dev_file = os.path.join(args.data_dir, 'dev_{}_{}.p'.format(args.label_threshold, args.ignore_labelless_docs))
        self.test_file = os.path.join(args.data_dir, 'test_{}_{}.p'.format(args.label_threshold, args.ignore_labelless_docs))
        self.label_desc_file = os.path.join(args.data_dir, "label_desc_{}.p".format(str(args.label_threshold)))
        self.mlb = pickle_load(os.path.join(args.data_dir, "mlb_{}_{}.p".format(str(args.label_threshold), args.ignore_labelless_docs)))
...
def convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        try:
            ...
            # all_lens.append(len(inputs['input_ids']))
        except:
            print(example)
