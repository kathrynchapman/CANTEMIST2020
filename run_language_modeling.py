...
def main():
    ...
    parser.add_argument('--msl', type=int, default=510, help="Intended max seq len")
    parser.add_argument('--stride', type=int, default=75, help="Overlap between documents")
    args = parser.parse_args()

    if not args.train_data_file:
        args.train_data_file ='processed_data/cantemist/LM_{}_{}_{}.txt'.format(args.model_name_or_path, str(args.msl), str(args.stride))
